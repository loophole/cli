...
const WebDav = () => {
  ...
  const startTunnel = () => {
    ...
    const message : Message = {
      ...
      startTunnelMessage: {
        tunnelType: "Tunnel_WebDav",
        exposeWebdavConfig: options,
      }
    }
  ...
  return (
    <div className="container">
      <h4 className="subtitle is-4">
        Exposes local directory to the public via loophole tunnel (download and upload mode)
        available through secure WebDAV.
      </h4>
